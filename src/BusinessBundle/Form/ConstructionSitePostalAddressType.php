...
class ConstructionSitePostalAddressType extends AbstractType {
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'BusinessBundle\Entity\ConstructionSitePostalAddress'
        ));
    }
    ...
    {
        return 'businessbundle_postaladdress';
    }
}